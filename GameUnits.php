...
namespace gameunits\PHPGameunits;

/**
 * Class to facilitate the communication to and from a Gameunits JSON-RPC server.
 *
 * @author  Liam Williams ( https://github.com/gameunits )
 */
class GameUnits
{
	/**
	...
	/**
	 * @param string $user     Gameunits-RPC username
	 * @param string $password Gameunits-RPC password
	 * @param string $host     Gameunits host (default 127.0.0.1)
	 * @param string $port     Gameunits port (1337)
	 *
	 * @throws \Exception
	 */
	public function __construct($user, $password, $host = '127.0.0.1', $port = '1337')
	{
	 ...
	 *
	 * @throws GameunitsException Thrown if invalid protocol value passed.
	 * @deprecated JSON-RPC over SSL has been deprecated and removed from newer gameunits-core versions.
	 */
	public function setProtocol($protocol)
	{
		switch ($protocol)
		{
			...
			case self::PROTOCOL_HTTP:
				...
				break;
			default:
				throw new GameUnitsException("Invalid Protocol");
		}
	}
	...
	public function setCertificate($filePath)
	{
		...
		{
			throw new GameUnitsException("Invalid Certificate Path");
		}
		...
		else if ($this->_status != 200)
		{
			switch ($this->_status)
			{
				...
				case 404:
					...
					break;
				default:
					throw new GameUnitsException("An unexpected http response code was encountered!");
			}
		}
...
/**
 * General exception for gameunits-related issues. (Requires message).
 */
class GameUnitsException extends \Exception
{
